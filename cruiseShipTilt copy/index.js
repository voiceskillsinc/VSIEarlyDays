...
const LaunchRequestHandler = {
  ...
  async handle(handlerInput) {
    ...
    if (!playbackInfo.hasPreviousPlaybackSession) {
      message = 'Welcome to the Deti Online. You can ask to play the audio to begin the story.';
...
const HelpHandler = {
  ...
  async handle(handlerInput) {
    ...
    if (!playbackInfo.hasPreviousPlaybackSession) {
      message = 'Welcome to the Deti Online. You can say, play the audio to begin the story.';
      ...
      message = 'You are listening to the Deti Online. You can say, Next or Previous to navigate through the playlist. At any time, you can say Pause to pause the audio and Resume to resume.';
    }
...
const controller = {
  async play(handlerInput) {
    ...
    responseBuilder
      ...
      .withShouldEndSession(true)
      .addAudioPlayerPlayDirective(playBehavior, story.url, token, offsetInMilliseconds, null);
